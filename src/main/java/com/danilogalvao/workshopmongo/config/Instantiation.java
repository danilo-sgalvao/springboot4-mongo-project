...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, LocalDate.parse("21/03/2018", formatter), "partiu viagem", "vou viajar para sao paulo", maria);
        Post post2 = new Post(null, LocalDate.parse("23/03/2018", formatter), "bom dia", "acordei feliz", maria);
